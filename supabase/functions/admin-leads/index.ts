    ...
    if (action === 'sync-industry') {
      ...
      const { data, error } = await supabase
        ...
        .upsert({
          ...
          ...(painPoints !== undefined && { pain_points: painPoints }),
          ...(bookingCtaKeywords !== undefined && { booking_cta_keywords: bookingCtaKeywords }),
          ...(researchedAt !== undefined && { researched_at: researchedAt }),
