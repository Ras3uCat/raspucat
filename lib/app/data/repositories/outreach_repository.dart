...
abstract class OutreachRepository {
  ...
  Future<List<OutreachEmailModel>> listSent({String? leadId});
  ...
  Future<String> getEmailPreview(String emailId);
...
class SupabaseOutreachRepository implements OutreachRepository {
  ...
  @override
  Future<List<OutreachEmailModel>> listSent({String? leadId}) async {
    final data = await _invoke('admin-outreach-email', {
      'action': 'list-sent',
      if (leadId != null) 'leadId': leadId,
    });
  ...
  Future<String> getEmailPreview(String emailId) async {
    final data = await _invoke('admin-outreach-email', {'action': 'preview', 'emailId': emailId});
