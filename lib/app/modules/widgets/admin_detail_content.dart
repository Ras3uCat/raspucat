...
enum _Tab { details, files, messages }
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            border: Border(
              bottom: BorderSide(color: EColors.primary.withValues(alpha: 0.12)),
            ),
          ),
          child: Row(
            children: [
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          divider,
          _Section(label: 'Management', children: [
            _Row(
              'Option',
          ...
          divider,
          _Section(label: 'Payment', children: [
            _Row('Card', cardLabel),
          ]),
          divider,
          _Section(label: 'Dates', children: [
          ...
          divider,
          AdminDetailActivity(
            events: detail['events'] as List<dynamic>? ?? [],
          ),
          divider,
          AdminDetailCancel(
            ctrl: ctrl,
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      Text(label.toUpperCase(), style: TextStyle(
        color: EColors.primary, fontSize: 10,
    ...
    child: Row(
      ...
      children: [
        ...
        Expanded(child: Text(value, style: const TextStyle(
          color: EColors.textWhite, fontSize: ESizes.fontSizeLabel,
        ))),
      ],
    ),
  );
...
class _PortalStageSection extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return _Section(label: 'Portal Stage', children: [
...
class _PendingModulesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _Section(label: 'Pending Modules', children: [
      const SizedBox(height: 4),
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('$name$price', style: const TextStyle(
                      color: EColors.textWhite, fontSize: ESizes.fontSizeLabel,
                    )),
                    if (purchasedAt.isNotEmpty)
                      Text(purchasedAt, style: TextStyle(
                        color: EColors.textSecondary.withValues(alpha: 0.5),
                        fontSize: 10,
                      )),
                    if (acknowledged)
                      Text('In Progress', style: TextStyle(
                        color: EColors.primary.withValues(alpha: 0.6), fontSize: 10,
                      )),
                  ],
                ),
              ),
              ...
              if (!acknowledged)
                Tooltip(
                  message: "Confirms you've received this request and are working on it. The client will see 'In Progress'.",
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(ESizes.borderRadiusSM),
                        border:
                            Border.all(color: EColors.gold.withValues(alpha: 0.4)),
                      ),
                ...
                Tooltip(
                  message: "Marks this module as delivered.",
                  child: GestureDetector(
                    onTap: () => ctrl.markModuleLive(pendingModuleId, quoteId),
                    child: Container(
                      padding: const EdgeInsets.symmetric(
                          horizontal: ESizes.sm, vertical: 3),
                      decoration: BoxDecoration(
                      ...
                      child: const Text('Mark Live', style: TextStyle(
                        color: EColors.primary,
                        fontSize: ESizes.fontSizeLabel,
                        fontWeight: FontWeight.w600,
                      )),
