...
class _ImageBlock extends StatelessWidget {
  const _ImageBlock({required this.project, required this.hovered, required this.onTap});
      ...
      child: Stack(
        children: [
          ...
          Positioned.fill(
            child: ClipRRect(
              borderRadius: BorderRadius.circular(ESizes.borderRadiusLg),
              child: Container(color: EColors.primary.withValues(alpha: 0.08)),
            ),
          ),
          Positioned.fill(
  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: technologies.take(3).map((tech) {
        ...
        return Container(
          padding: const EdgeInsets.symmetric(horizontal: ESizes.md - 4, vertical: ESizes.xs + 2),
          decoration: BoxDecoration(
