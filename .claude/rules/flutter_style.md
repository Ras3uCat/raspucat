---
description: Flutter widget and file conventions. Apply when editing any Dart file in lib/.
globs: ["lib/**/*.dart"]
---
...
```
quote_detail_view.dart       ← main entry point, stays lean
_quote_detail_header.dart    ← extracted widget, prefixed with _
_quote_detail_tabs.dart      ← another extracted widget
```
