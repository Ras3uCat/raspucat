...
If any are missing → BLOCK implementation and return the file to Planner.
...
- Repository pattern mandatory at data layer.
- 300-line file limit. Refactor immediately when exceeded.
- Auth/Payments/Permissions: never trust client state.

## Project Structure
- Flutter app: `lib/app/modules/<feature>/`
- Backend: `supabase/`
