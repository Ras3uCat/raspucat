...
```
[Hero] → [About] → [Skills] → [Projects] → [Plans] → [How It Works] → [Contact]
  ↓          ↓          ↓           ↓            ↓            ↓              ↓
Hook      Trust      Fit         Proof       Anchor       Process         Action
```
...
| **Process** | How It Works | "What happens after I reach out?" | Removes uncertainty. Confident visitor = more likely to act. |
...
| :--- | :--- | :--- |
| Section order | Hero → About → Skills → Projects → Plans → How It Works → Contact → Footer | Natural narrative flow: who → what → work → process → hire |
...
4. ~~Preferred section order on the page?~~ → Confirmed: Hero → About → Skills → Projects → Plans → How It Works → Contact → Footer
